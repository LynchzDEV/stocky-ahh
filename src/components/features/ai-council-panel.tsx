...
export function AiCouncilPanel({
  ...
  // Reset activeTab when results change (e.g. new council run with different models)
  useEffect(() => {
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-1.5">
                ...
                {!r.loading && !r.error && r.analysis && (
                  <span
                    className={cn('font-bold', getScoreColor(r.analysis.score))}
                  >
                    {r.analysis.score}
                  </span>
                )}
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <div
                    className={cn(
                      ...
                      getScoreColor(activeResult.analysis.score),
                    )}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {activeResult.analysis.confidence}% confidence
                    </p>
                  </div>
                </div>
                  ...
                  <div className="p-3 rounded-lg bg-cyan-500/5 border border-cyan-500/20 space-y-1">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs">
                        {activeResult.analysis.bottomFishing.timing}
                      </span>
                    </div>
                  </div>
                  <div className="p-3 rounded-lg bg-green-500/5 border border-green-500/20 space-y-1">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs font-mono font-medium text-green-400">
                        $
                        {activeResult.analysis.priceTarget.targetPrice.toFixed(
                          2,
                        )}
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs">
                        {activeResult.analysis.priceTarget.timeframe}
                      </span>
                    </div>
                  </div>
                </div>
